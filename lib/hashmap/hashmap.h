...
typedef struct Hashmap {
    ...
    void (*init)(struct Hashmap *const this);
    void (*put)(struct Hashmap *const this, StringsPair pair);
    void (*remove)(struct Hashmap *const this, string key);
    void (*get)(struct Hashmap *const this, string key, StringsPair *pair);
    void (*clear)(struct Hashmap *const this);
    void (*print)(struct Hashmap *const this);
} Hashmap;
